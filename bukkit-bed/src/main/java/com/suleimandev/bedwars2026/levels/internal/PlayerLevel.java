...
import com.suleimandev.bedwars2026.api.events.player.PlayerLevelUpEvent;
...
public class PlayerLevel {
    ...
    public void destroy() {
        ...
        //BukkitBedPlugin.getRemoteDatabase().setLevelData(uuid, level, currentXp, LevelsConfig.levels.getYml().get("levels." + level + ".name") == null ?
    ...
    public void updateDatabase() {
        if (modified) {
            Bukkit.getScheduler().runTaskAsynchronously(BukkitBedPlugin.plugin, () -> BukkitBedPlugin.getRemoteDatabase().setLevelData(uuid, level, currentXp, LevelsConfig.getLevelName(level), nextLevelCost));
            modified = false;
        }
    }
}
