...
public class Spanish extends Language {
    ...
    public Spanish() {
        super(BukkitBedPlugin.plugin, "es");
        ...
        yml.addDefault(Messages.COMMAND_MAIN, Arrays.asList("", "&2Ã¢â€“Âª &7/" + mainCmd + " stats", "&2Ã¢â€“Âª &7/" + mainCmd + " join &o<arena/grupo>", "&2Ã¢â€“Âª &7/" + mainCmd + " leave", "&2Ã¢â€“Âª &7/" + mainCmd + " lang", "&2Ã¢â€“Âª &7/" + mainCmd + " gui", "&2Ã¢â€“Âª &7/" + mainCmd + " start &3(vip)"));
        yml.addDefault(Messages.ARENA_JOIN_VIP_KICK, "{prefix}&cHas sido expulsado ya que un VIP se ha unido a la partida.\n&aConsidere hacer una donaciÃƒÂ³n para obtener mÃƒÂ¡s funciones. &7&o(click)");
        yml.addDefault(Messages.COMMAND_JOIN_DENIED_IS_FULL, "{prefix}&cEsta arena estÃƒÂ¡ llena!\n&aConsidere hacer una donaciÃƒÂ³n para obtener mÃƒÂ¡s funciones. &7&o(click)");
        yml.addDefault(Messages.COMMAND_JOIN_DENIED_IS_FULL_OF_VIPS, "{prefix}&cEsta arena esta llena!.\n&cConsidere hacer una donaciÃƒÂ³n para obtener mÃƒÂ¡s funciones. &7&o(click).");
        yml.addDefault(Messages.ARENA_START_COUNTDOWN_STOPPED_INSUFF_PLAYERS_CHAT, "{prefix}Ã‚Â§cNo hay suficientes jugadores! La cuenta regresiva ha sido frenada!");
        yml.addDefault(Messages.COMMAND_LEAVE_MSG, "{prefix}&e{player} ha salido!");
        yml.addDefault(Messages.ARENA_RESTART_PLAYER_KICK, "{prefix}&eLa arena en la que estabas se estÃƒÂ¡ reiniciando.");
        ...
        yml.addDefault(Messages.ARENA_STATUS_WAITING_NAME, "&2En Espera Ã‚Â§c{full}");
        yml.addDefault(Messages.ARENA_STATUS_STARTING_NAME, "&6Comenzando Ã‚Â§c{full}");
        ...
        yml.addDefault(Messages.COMMAND_TP_NOT_IN_ARENA, "{prefix}&cEste jugador no estÃƒÂ¡ en una arena de bedwars.!");
        yml.addDefault(Messages.COMMAND_TP_NOT_STARTED, "{prefix}&cLa arena donde estÃƒÂ¡ el jugador aÃƒÂºn no comenzÃƒÂ³.!");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_DENIED_PARTY_TOO_BIG, "{prefix}&cTu party es demasiado grande para unirte a esta partida como equipo. Considera reducir el tamaÃƒÂ±o o ingresar a una arena mÃƒÂ¡s grande.");
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CANCELLED_SUB_TITLE, "&cEsperando mÃƒÂ¡s jugadores..");
        ...
        yml.addDefault(Messages.FORMATTING_SCOREBOARD_HEALTH, Arrays.asList("&cÃ¢ÂÂ¤", "&aSalud"));
        ...
        yml.addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&cCAMA DESTRUÃƒÂDA!");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_SUBTITLE_ANNOUNCEMENT, "&fYa no reaparecerÃƒÂ¡s!");
        ...
        yml.addDefault(Messages.INTERACT_INVISIBILITY_REMOVED_DAMGE_TAKEN, "&cYa no eres invisible porque has recibido daÃƒÂ±o!");
        yml.addDefault(Messages.TEAM_ELIMINATED_CHAT, "\n&f&lEQUIPO ELIMINADO > El equipo {TeamColor}{TeamName} &cha sido eliminado\n");
        yml.addDefault(Messages.PLAYER_DIE_VOID_FALL_REGULAR_KILL, "{PlayerColor}{PlayerName} &7ha caÃƒÂ­do al vacio.");
        yml.addDefault(Messages.PLAYER_DIE_VOID_FALL_FINAL_KILL, "{PlayerColor}{PlayerName} &7ha caÃƒÂ­do al vacio. &b&lMUERTE FINAL!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_SUBTITLE, "&eReaparecerÃƒÂ¡s en &c{time} &esegundos!");
        yml.addDefault(Messages.PLAYER_DIE_RESPAWN_CHAT, "{prefix}&eReaparecerÃƒÂ¡s en &c{time} &esegundos!");
        ...
        yml.addDefault(Messages.GAME_END_TOP_PLAYER_CHAT, Arrays.asList("&aÃ¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬",
                ...
                "&6                     &6Ã¢Â­Â &l1er Asesino &7- {topTeamColor}{topPlayerDisplayName} &7- &l{topValue}",
        ...
        yml.addDefault(Messages.COMMAND_JOIN_USAGE, "Ã‚Â§aÃ¢â€“Âª Ã‚Â§7Usa: /" + mainCmd + " join Ã‚Â§o<arena/grupo>");
        ...
        yml.addDefault("upgrades.Default.trap.tier1.lore", Arrays.asList("&7El proximo enemigo en entrar", "&7a tÃƒÂº base recibirÃƒÂ¡ efecto", "&7v!", "", "&8Precio:&b {cost} {currency}", "", "{loreFooter}"));
        yml.addDefault("upgrades.Default.miningFatigue.tier1.name", "&eTrampa de Fatiga Minera");
        yml.addDefault("upgrades.Default.miningFatigue.tier1.lore", Arrays.asList("&7El prÃƒÂ³ximo enemigo en entrar a tÃƒÂº", "&7base recibirÃƒÂ¡ Fatiga al minar", "&7por 10 segundos!", "", "&8Precio:&b {cost} {currency}", "", "{loreFooter}"));
        ...
        yml.addDefault(Messages.PLAYER_DIE_UNKNOWN_REASON_REGULAR, "{PlayerColor}{PlayerName} &7muriÃƒÂ³.");
        yml.addDefault(Messages.PLAYER_DIE_UNKNOWN_REASON_FINAL_KILL, "{PlayerColor}{PlayerName} &7muriÃƒÂ³. &b&lMUERTE FINAL!");
        ...
        yml.addDefault(Messages.PLAYER_STATS_GUI_INV_NAME, "&8{player} EstadistÃƒÂ­cas");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player} &eno estÃƒÂ¡ conectado!");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_SENT, "{prefix}&eInvitaciÃƒÂ³n enviada a &7{player}&6.");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_REMOVE_DENIED_TARGET_NOT_PARTY_MEMBER, "{prefix}&7{player} &eno estÃƒÂ¡ en tu party!");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_SUCCESS, "{prefix}&eHas promovido exitosamente a {player} a dueÃƒÂ±o");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_OWNER, "{prefix}&eHas sido promovido a dueÃƒÂ±o del grupo");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_NEW_OWNER, "{prefix}&7 &e{player} ha sido promovido a dueÃƒÂ±o");
        yml.addDefault(Messages.COMMAND_PARTY_INFO_OWNER, "\n{prefix}&eEl dueÃƒÂ±o del grupo es: &7{owner}");
        ...
        yml.addDefault(Messages.NEXT_EVENT_DRAGON_SPAWN, "&fMuerte SÃƒÂºbita");
        ...
        yml.addDefault(Messages.NEXT_EVENT_TITLE_ANNOUNCE_SUDDEN_DEATH, "&cMuerte sÃƒÂºbita");
        yml.addDefault(Messages.NEXT_EVENT_SUBTITLE_ANNOUNCE_SUDDEN_DEATH, "");
        yml.addDefault(Messages.NEXT_EVENT_CHAT_ANNOUNCE_SUDDEN_DEATH, "&cMUERTE SÃƒÅ¡BITA: &6&b{TeamDragons} {TeamColor}{TeamName} Dragon!");
        yml.addDefault(Messages.COMMAND_NOT_FOUND_OR_INSUFF_PERMS, "{prefix}&cComando no encontrado o permisos insuficientes!");
        yml.addDefault(Messages.COMMAND_FORCESTART_NOT_IN_GAME, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7No estas jugando!");
        yml.addDefault(Messages.COMMAND_FORCESTART_SUCCESS, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Cuenta regresiva comenzada!");
        yml.addDefault(Messages.COMMAND_FORCESTART_NO_PERM, "{prefix}&7Tu no puedes forzar el comienzo de la arena.\nÃ‚Â§7Esta es una funcion que solo miembros staff pueden utilizar.");
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_MSG, "{prefix}Ã‚Â§6Estas ahora espectando la arena Ã‚Â§9{arena}Ã‚Â§6.\n{prefix}Ã‚Â§ePuedes dejar la arena en cualquier momento escribiendo Ã‚Â§c/leaveÃ‚Â§e.");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player} &eno estÃƒÂ¡ conectado!");
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG, "&cLos espectadores no estÃƒÂ¡n permitidos en esta arena!");

        yml.addDefault(Messages.ARENA_LEAVE_PARTY_DISBANDED, "{prefix}Ã‚Â§cEl dueÃƒÂ±o de la party se fue y la party se disolviÃƒÂ³!");
        yml.addDefault(Messages.XP_REWARD_PER_MINUTE, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Tiempo de juego).");
        yml.addDefault(Messages.XP_REWARD_WIN, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Victoria).");
        yml.addDefault(Messages.XP_REWARD_PER_TEAMMATE, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Apoyo de equipo).");
        yml.addDefault(Messages.XP_REWARD_BED_DESTROY, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Cama Destruida).");
        yml.addDefault(Messages.XP_REWARD_REGULAR_KILL, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Asesinato).");
        yml.addDefault(Messages.XP_REWARD_FINAL_KILL, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Asesinato Final).");
        ...
        yml.addDefault(Messages.SHOP_QUICK_ADD_NAME, "&8Agregando a la Compra RÃƒÂ¡pida...");
        ...
        yml.addDefault(Messages.XP_REWARD_PER_MINUTE, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Tiempo de juego).");
        yml.addDefault(Messages.XP_REWARD_WIN, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Victoria).");
        yml.addDefault(Messages.XP_REWARD_PER_TEAMMATE, "{prefix}&6+{xp} Experiencia de BukkitBedPlugin recibida (Ayuda al equipo).");
        ...
        //shop
        yml.addDefault(Messages.SHOP_INDEX_NAME, "&8Compra rapida");
        yml.addDefault(Messages.SHOP_INSUFFICIENT_MONEY, "{prefix}&cNo tienes suficiente {currency}! Necesitas {amount} mÃƒÂ¡s!");
        ...
        yml.addDefault(Messages.SHOP_SEPARATOR_NAME, "&8Ã¢â€¡Â§ CategorÃƒÂ­as");
        yml.addDefault(Messages.SHOP_SEPARATOR_LORE, Collections.singletonList("&8Ã¢â€¡Â© Items"));
        yml.addDefault(Messages.SHOP_QUICK_BUY_NAME, "&bCompra rapida");
        yml.addDefault(Messages.SHOP_QUICK_BUY_LORE, new ArrayList<>());
        yml.addDefault(Messages.SHOP_QUICK_EMPTY_NAME, "&cRanura vacÃƒÂ­a!");
        yml.addDefault(Messages.SHOP_QUICK_EMPTY_LORE, Arrays.asList("&7Esta es una ranura de compra rÃƒÂ¡pida!", "&bShift + click &7a cualquier item", "&7de la tienda para agregarlo aquÃƒÂ­."));
        ...
        addContentMessages(yml, "clay", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Arcilla", Arrays.asList("&7Precio: {cost} {currency}", "", "&7Bloque bÃƒÂ¡sico para defender tu cama.", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "stone", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}End Stone", Arrays.asList("&7Precio: {cost} {currency}", "", "&7Bloque sÃƒÂ³lido para defender tu cama.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "ladder", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Escalera", Arrays.asList("&7Precio: {cost} {currency}", "", "&7ÃƒÅ¡til para salvar gatos atrapados en", "&7arboles.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "obsidian", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Obsidiana", Arrays.asList("&7Precio: {cost} {currency}", "", "&7ProtecciÃƒÂ³n extrema para tu cama.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "wood", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Madera", Arrays.asList("&7Precio: {cost} {currency}", "", "&7Bloque sÃƒÂ³lido para defender tu cama", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "golden-apple", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Manzana de oro", Arrays.asList("&7Precio: {cost} {currency}", "", "&7CuraciÃƒÂ³n completa.", "", "{quick_buy}", "{buy_status}"));
        ...
        addContentMessages(yml, "dream-defender", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Defensor de los sueÃƒÂ±os", Arrays.asList("&7Precio: {cost} {currency}", "", "&7Un Golem de Hierro para ayudar a defender tu",
                "&7base. Dura 4 minutos.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "fireball", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Bola de fuego", Arrays.asList("&7Precio: {cost} {currency}", "", "&7Ã‚Â¡Haz clic derecho para volar! Genial para",
        ...
        addContentMessages(yml, "ender-pearl", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Ender Pearl", Arrays.asList("&7Precio: {cost} {currency}", "", "&7La forma mÃƒÂ¡s rÃƒÂ¡pida de invadir las bases",
        ...
        /* Lobby Command Items */
        yml.addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_NAME.replace("%path%", "stats"), "&lEstadistÃƒÂ­cas");
        yml.addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "stats"), Arrays.asList("&7Utiliza este objeto para", "&7ver tus estadÃƒÂ­sticas."));
        ...
        yml.addDefault(Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_NAME.replace("%path%", "stats"), "&lEstadistÃƒÂ­cas");
        yml.addDefault(Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_LORE.replace("%path%", "stats"), Arrays.asList("&7Utiliza este objeto para", "&7ver tus estadÃƒÂ­sticas."));
        ...
        yml.addDefault(Messages.COMMAND_COOLDOWN, "&cNo puedes hacer eso aÃƒÂºn! Espera {seconds} segundos mÃƒÂ¡s!");
        ...
        yml.addDefault(Messages.ARENA_JOIN_DENIED_NO_PROXY, "&cLo siento, pero debes unirte a una arena usando BedWarsProxy. \n&eSi desea configurar una arena, asegÃƒÂºrese de otorgarse el permiso bw.setup para que pueda unirse al servidor directamente!");

        yml.addDefault(Messages.REJOIN_NO_ARENA, "{prefix}&cNo hay arena a la cual unirse. Recuerda que sÃƒÂ³lo puedes ingresar a una 5 minutos despuÃƒÂ©s del comienzo de la partida!");
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_LORE.replace("{name}", "forge"),
                Arrays.asList("&7Actualice la generaciÃƒÂ³n de recursos en", "&7su isla.", "", "{tier_1_color}Nivel 1: +50% de Recursos, &b{tier_1_cost} {tier_1_currency}",
        ...
        yml.addDefault(Messages.UPGRADES_CATEGORY_ITEM_LORE_PATH + "traps", Arrays.asList("&7Las trampas compradas serÃƒÂ¡n", "&7guardadas en la cola.", "", "&eClick para navegar!"));
        ...
        yml.addDefault(Messages.UPGRADES_UPGRADE_TIER_ITEM_NAME.replace("{name}", "heal-pool").replace("{tier}", "tier-1"), "{color}Piscina de curaciÃƒÂ³n");
        ...
        yml.addDefault(Messages.UPGRADES_SEPARATOR_ITEM_NAME_PATH + "glass", "&8Ã¢Â¬â€ &7Comprable");
        yml.addDefault(Messages.UPGRADES_SEPARATOR_ITEM_LORE_PATH + "glass", Collections.singletonList("&8Ã¢Â¬â€¡&7Cola de Trampas"));
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_SLOT_ITEM_LORE2_PATH + "first",
                Arrays.asList("", "&7La compra de una trampa.", "&7la pondra en cola aqui. Su costo", "&7se basarÃƒÂ¡ en una escala del", "&7numero de trampas.", "", "&7Siguiente trampa: &b{cost} {currency}"));
