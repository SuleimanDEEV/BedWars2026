...
public class Romanian extends Language {
    ...
    public Romanian() {
        super(BukkitBedPlugin.plugin, "ro");
        YamlConfiguration yml = getYml();
        yml.addDefault(Messages.PREFIX, "");
        yml.addDefault("name", "RomÃƒÂ¢nÃ„Æ’");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_USAGE, "Ã‚Â§aÃ¢â€“Âª Ã‚Â§7Folosire: /" + mainCmd + " join Ã‚Â§o<arena/group>");
        ...
        yml.addDefault(Messages.COMMAND_FORCESTART_NOT_IN_GAME, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Nu esti in joc!");
        yml.addDefault(Messages.COMMAND_FORCESTART_SUCCESS, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Numaratoarea a fost redusa!");
        yml.addDefault(Messages.COMMAND_FORCESTART_NO_PERM, "{prefix}&7Nu poti forta arena sa inceapa.\nÃ‚Â§7Ai putea lua in considerare donarea pentru mai multe facilitati.");
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_MSG, "{prefix}Ã‚Â§6Acum urmaresti meciul din Ã‚Â§9{arena}Ã‚Â§6.\n{prefix}Ã‚Â§ePoti parasi arena folosind Ã‚Â§c/leaveÃ‚Â§e.");
        ...
        yml.addDefault(Messages.ARENA_START_COUNTDOWN_STOPPED_INSUFF_PLAYERS_CHAT, "{prefix}Ã‚Â§cNu sunt destui jucatori! Numaratoarea a fost oprita!");
        ...
        yml.addDefault(Messages.ARENA_STATUS_WAITING_NAME, "&2In Asteptare Ã‚Â§c{full}");
        yml.addDefault(Messages.ARENA_STATUS_STARTING_NAME, "&6Porneste Ã‚Â§c{full}");
        ...
        yml.addDefault(Messages.ARENA_LEAVE_PARTY_DISBANDED, "{prefix}Ã‚Â§cParty-ul a fost sters pentru ca detinatorul a iesit!");
        ...
        yml.addDefault(Messages.FORMATTING_SCOREBOARD_HEALTH, Arrays.asList("&cÃ¢ÂÂ¤", "&aViaÃˆâ€ºÃ„Æ’"));
        ...
        yml.addDefault(Messages.GAME_END_TOP_PLAYER_CHAT, Arrays.asList("&aÃ¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬",
                ...
                "&6                 &6Ã¢Â­Â &lPrimul Ucigas &7- {topTeamColor}{topPlayerDisplayName} &7- &l{topValue}",
        ...
        yml.addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "leave"), Arrays.asList("&fClick-dreapta pentru a", "&fparasi BukkitBedPlugin!"));
        ...
        yml.addDefault(Messages.GENERAL_CONFIGURATION_WAITING_ITEMS_LORE.replace("%path%", "leave"), Arrays.asList("&fClick-dreapta pentru a", "&fparasi BukkitBedPlugin!"));
        ...
        yml.addDefault(Messages.XP_REWARD_PER_MINUTE, "{prefix}&6+{xp} BukkitBedPlugin Experience Received (Play Time).");
        yml.addDefault(Messages.XP_REWARD_WIN, "{prefix}&6+{xp} BukkitBedPlugin Experience Received (Game Win).");
        yml.addDefault(Messages.XP_REWARD_PER_TEAMMATE, "{prefix}&6+{xp} BukkitBedPlugin Experience Received (Team Support).");
        ...
        yml.addDefault(Messages.SHOP_SEPARATOR_NAME, "&8Ã¢â€¡Â§ Categorii");
        yml.addDefault(Messages.SHOP_SEPARATOR_LORE, Collections.singletonList("&8Ã¢â€¡Â© Obiecte"));
        ...
        yml.addDefault(Messages.SHOP_QUICK_EMPTY_LORE, Arrays.asList("&Acesta este un slot pentru Shopul Rapid!", "&bShift Click &7pe orice obiect din", "&7shop pentru a-l adÃ„Æ’uga aici."));
        ...
        yml.addDefault(Messages.SHOP_LORE_QUICK_REMOVE, "&bShift Click pentru a Ãˆâ„¢terge din Shop Rapid!");


        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "&8Blocuri", "&aBlocuri", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "wool", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Lana", Arrays.asList("&7PreÃˆâ€º: &f{cost} {currency}", "", "&7Great for bridging across", "&7islands. Turns into your team's",
                "&7color.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "clay", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Lut ÃƒÅ½ntÃ„Æ’rit", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Bloc esenÃˆâ€ºial pentru a proteja patul.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "glass", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}SticlÃ„Æ’ Anti-Explozibil", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7ImunÃ„Æ’ ÃƒÂ®mpotriva exploziilor.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "stone", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}PiatrÃ„Æ’ Din End", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Bloc solid pentru a proteja patul.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "ladder", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}ScarÃ„Æ’", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7UtilÃ„Æ’ pentru a salva pisicile blocate", "&7in copaci.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "obsidian", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Obsidian", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7ProtecÃˆâ€ºie extrema pentru pat.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "wood", ConfigPath.SHOP_PATH_CATEGORY_BLOCKS, "{color}Lemn", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Bloc solid pentru a-Ãˆâ€ºi proteja patul.", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_MELEE, "&8Atac", "&aAtac", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "stone-sword", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "{color}Sabie De PiatrÃ„Æ’", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "iron-sword", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "{color}Sabie De Fier", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "diamond-sword", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "{color}Sabie De Diamant", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "stick", ConfigPath.SHOP_PATH_CATEGORY_MELEE, "{color}BÃ„Æ’Ãˆâ€º (ÃƒÅ½mpingere I)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_ARMOR, "&8ArmurÃ„Æ’", "&aArmurÃ„Æ’", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));

        addContentMessages(yml, "chainmail", ConfigPath.SHOP_PATH_CATEGORY_ARMOR, "{color}ArmurÃ„Æ’ PermanentÃ„Æ’ De Zale", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}",
                "", "&7Pantaloni Ãˆâ„¢i cizme de zale", "&7cu care te vei spawna mereu.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "iron-armor", ConfigPath.SHOP_PATH_CATEGORY_ARMOR, "{color}ArmurÃ„Æ’ PermanentÃ„Æ’ De Fier", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}",
                "", "&7Pantaloni Ãˆâ„¢i cizme de fier", "&7cu care te vei spawna mereu.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "diamond-armor", ConfigPath.SHOP_PATH_CATEGORY_ARMOR, "{color}ArmurÃ„Æ’ PermanentÃ„Æ’ De Diamant", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}",
                "", "&7Pantaloni Ãˆâ„¢i cizme de diamant", "&7cu care te vei spawna mereu.", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "&8Unelte", "&aUnelte", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "shears", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}Foarfece Permanente", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}",
                "", "&7Perfecte pentru a tÃ„Æ’ia lÃƒÂ¢na. Te vei", "&7spawna mereu cu ele in inventar.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "pickaxe", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}TÃƒÂ¢rnÃ„Æ’cop {tier}", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "&7Nivel: &e{tier}",
        ...
        addContentMessages(yml, "axe", ConfigPath.SHOP_PATH_CATEGORY_TOOLS, "{color}Topor {tier}", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "&7Tier: &e{tier}",
                "", "&7Este un obiect upgradabil.", "&7Vei pierde cate un nivel atunci cand", "&7vei muri!", "", "&7Te vei respawna mereu", "&7cu cel putin primul nivel", "&7al acestui obiect.", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_RANGED, "&8Atac La DistanÃˆâ€ºÃ„Æ’", "&aAtac La DistanÃˆâ€ºÃ„Æ’", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "arrow", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "{color}SageÃˆâ€ºi", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "bow1", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "{color}Arc", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "bow2", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "{color}Arc (Putere I)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "bow3", ConfigPath.SHOP_PATH_CATEGORY_RANGED, "{color}Arc (Putere I, ÃƒÅ½mpingere I)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "&8PoÃˆâ€ºiuni", "&aPotÃˆâ€ºiuni", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "speed-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}VitezÃ„Æ’ II (45 secunde)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "jump-potion", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}SÃ„Æ’riturÃ„Æ’ V (45 secunde)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "invisibility", ConfigPath.SHOP_PATH_CATEGORY_POTIONS, "{color}Invizibilitate (30 secunde)", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "{quick_buy}", "{buy_status}"));

        addCategoryMessages(yml, ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "&8Utilaje", "&aUtilaje", Collections.singletonList("&eClick pentru a afiÃˆâ„¢a!"));
        addContentMessages(yml, "golden-apple", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}MÃ„Æ’r Auriu", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7VindecÃ„Æ’tor bine rotunjit.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "bedbug", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}BedBug", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7SpawneazÃ„Æ’ un Silverfish acolo unde",
                "&7aterizeazÃ„Æ’ bugÃ„Æ’rul de zÃ„Æ’padÃ„Æ’, pentru a", "&7distrage inamicii. TrÃ„Æ’ieÃˆâ„¢te 15 secunde.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "dream-defender", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}ApÃ„Æ’rÃ„Æ’torul Viselor", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Un Iron Golem care te ajutÃ„Æ’ sÃ„Æ’",
                "&7ÃƒÂ®Ãˆâ€ºi protejezi baza. TrÃ„Æ’ieÃˆâ„¢te 4 minute.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "fireball", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}BilÃ„Æ’ De Foc", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Click-dreapta pentru a lansa!",
                "&7ÃƒÅ½mpinge inamicii care merg pe", "&7poduri.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "tnt", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}TNT", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Se aprinde instant, potrivit",
                "&7pentru a exploda chestii!", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "ender-pearl", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Ender Pearl", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Cel mai rapid mod pentru a invada",
                "&7bazele inamice.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "water-bucket", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}GÃ„Æ’leatÃ„Æ’ Cu ApÃ„Æ’", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Util pentru a incetini",
                "&7inamicii. Te poate proteja Ãˆâ„¢i", "&7ÃƒÂ®mpotriva TNT-ilui.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "bridge-egg", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Bridge Egg", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Acest ou creeazÃ„Æ’ un pod in",
                "&7direcÃˆâ€ºia in care este aruncat.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "magic-milk", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Lapte Magic", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7EvitÃ„Æ’ capcanele timp de 60",
                "&7de secunde dupÃ„Æ’ ce l-ai bÃ„Æ’ut.", "", "{quick_buy}", "{buy_status}"));
        addContentMessages(yml, "sponge", ConfigPath.SHOP_PATH_CATEGORY_UTILITY, "{color}Burete", Arrays.asList("&7PreÃˆâ€º: {cost} {currency}", "", "&7Util pentru a absorbi apa.",
        ...
        yml.addDefault(Messages.UPGRADES_TRAP_DEFAULT_MSG, "&c&l{trap} a fost activatÃ„Æ’!");
        yml.addDefault(Messages.UPGRADES_TRAP_DEFAULT_TITLE, "&cCAPCANÃ„â€š ACTIVATÃ„â€š!");
        yml.addDefault(Messages.UPGRADES_TRAP_DEFAULT_SUBTITLE, "&fCapcana {trap} a fost activatÃ„Æ’!");
