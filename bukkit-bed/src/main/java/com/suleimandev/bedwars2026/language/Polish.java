...
public class Polish extends Language{
    ...
    public Polish() {
        super(BukkitBedPlugin.plugin, "pl");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_USAGE, "Ã‚Â§aÃ¢â€“Âª Ã‚Â§7Uzyj: /" + mainCmd + " join Ã‚Â§o<arena/grupa>");
        ...
        yml.addDefault(Messages.COMMAND_TP_NOT_STARTED, "{prefix}&cArena na ktÃƒÂ³rej jest ten gracza, jeszcze siÃ„â„¢ nie rozpoczeÃ…â€ša!");
        yml.addDefault(Messages.COMMAND_TP_USAGE, "{prefix}&cUzycie: /bw tp <gracz>");
        yml.addDefault(Messages.COMMAND_REJOIN_PLAYER_RECONNECTED, "{prefix}&7{player} &eponownie siÃ„â„¢ poÃ…â€šÃ„â€¦czyÃ…â€š!");
        ...
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_SUCCESS, "{prefix}&ePomyÃ…â€ºlnie awansowaÃ…â€šeÃ…â€º {player} na wÃ…â€šaÃ…â€ºciciela");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_OWNER, "{prefix}&eZostaÃ…â€šeÃ…â€º awansowany na wÃ…â€šaÃ…â€ºciciela grupy");
        yml.addDefault(Messages.COMMAND_PARTY_PROMOTE_NEW_OWNER, "{prefix}&7 &e{player} zostaÃ…â€š awansowany na wÃ…â€šaÃ…â€ºciciela");
        yml.addDefault(Messages.COMMAND_PARTY_INFO_OWNER, "\n{prefix}&eWÃ…â€šaÃ…â€ºcicielem grupy jest: &7{owner}");
        yml.addDefault(Messages.COMMAND_PARTY_INFO_PLAYERS,"{prefix}&eCzÃ…â€šonkowie grupy to:");
        ...
        yml.addDefault(Messages.COMMAND_FORCESTART_NOT_IN_GAME, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Nie jestes w zadnej grze!");
        yml.addDefault(Messages.COMMAND_FORCESTART_SUCCESS, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Odliczanie zostalo skrocone!");
        yml.addDefault(Messages.COMMAND_FORCESTART_NO_PERM, "{prefix}&Nie mozesz glosowac na natychmiastowy start areny.\nÃ‚Â§7Rozwaz kupno rangi VIP+ aby odblokowac mase nowych funkcji!");
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_MSG, "{prefix}Ã‚Â§6Obserwujesz teraz arene &9{arena}&6.\n{prefix}Ã‚Â§eMozesz opuscic gre wpisujac &c/leave&e.");
        yml.addDefault(Messages.COMMAND_PARTY_INVITE_DENIED_PLAYER_OFFLINE, "{prefix}&7{player} &ejest offline!");
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_DENIED_MSG, "&cWidzowie nei majÃ„â€¦ wstÃ„â„¢pu na tÃ„â„¢ arene!");
        yml.addDefault(Messages.COMMAND_COOLDOWN, "&cNie moÃ…Â¼esz tego zrobiÃ„â€¡! Poczekaj {seconds}!");
        ...
        yml.addDefault(Messages.ARENA_SPECTATOR_TELEPORTER_GUI_HEAD_LORE, Arrays.asList("&7Zycie: &f{health}%", "&7Jedzenie: &f{food}", "", "&7Kliknij lewym by oglÃ„â€¦daÃ„â€¡"));
        ...
        yml.addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_ENTER_SUBTITLE, "&cKUCNIJ aby wyjÃ…â€ºÃ„â€¡");
        yml.addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_LEAVE_TITLE, "&eWychodzisz z trybu widza!");
        yml.addDefault(Messages.ARENA_SPECTATOR_FIRST_PERSON_LEAVE_SUBTITLE, "");
        yml.addDefault(Messages.ARENA_LEAVE_PARTY_DISBANDED, "{prefix}Ã‚Â§cZalozyciel party opuscil gre, party zostaje rozwiazane!");
        ...
        yml.addDefault(Messages.ARENA_STATUS_WAITING_NAME, "&2Oczekiwanie Ã‚Â§c{full}");
        yml.addDefault(Messages.ARENA_STATUS_STARTING_NAME, "&6Rozpoczynanie Ã‚Â§c{full}");
        ...
        yml.addDefault(Messages.ARENA_STATUS_START_COUNTDOWN_CANCELLED_SUB_TITLE, "&cCzekamy na wiÃ„â„¢cej graczy...");
        ...
        yml.addDefault(Messages.ARENA_JOIN_DENIED_SELECTOR, "{prefix}&cAktualnie nie moÃ…Â¼esz doÃ…â€šÃ„â€¦czyÃ„â€¡ do tej areny, kliknij PPM aby oglÃ„â€¦daÃ„â€¡ arene");
        yml.addDefault(Messages.ARENA_SPECTATE_DENIED_SELECTOR, "{prefix}&cAktualnie nie moÃ…Â¼esz obserwowaÃ„â€¡ tej areny, kliknij LMP aby doÃ…â€šÃ„â€¦czyÃ„â€¡");
        yml.addDefault(Messages.ARENA_JOIN_DENIED_NO_PROXY, "&cPrzykro nam, ale musisz doÃ…â€šÃ„â€¦czyÃ„â€¡ do areny uÃ…Â¼ywajÃ„â€¦c BedWarsProxy. \n&eJeÃ…â€ºli chcesz utworzyÃ„â€¡ arenÃ„â„¢, upewnij siÃ„â„¢, Ã…Â¼e nadaÃ…â€šeÃ…â€º sobie uprawnienia bw.setup, aby mÃƒÂ³c bezpoÃ…â€ºrednio doÃ…â€šÃ„â€¦czyÃ„â€¡ do serwera!");
        ...
        yml.addDefault(Messages.FORMATTING_SCOREBOARD_HEALTH, Arrays.asList("&cÃ¢ÂÂ¤", "&aZYCIA"));
        ...
        yml.addDefault(Messages.INTERACT_BED_DESTROY_CHAT_ANNOUNCEMENT, "\n&f&lDESTRUCKJA LOZKA > {TeamColor}{TeamName}&7Zostalo usmaÃ…Â¼one w gÃ…â€šÃ„â„¢bokim tÃ…â€šuszczu przez {PlayerColor}{PlayerName}&7!\n");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_TITLE_ANNOUNCEMENT, "&cLOZKO ZNISZCZONE!");
        yml.addDefault(Messages.INTERACT_BED_DESTROY_SUBTITLE_ANNOUNCEMENT, "&fNie bÃ„â„¢dziesz juÃ…Â¼ siÃ„â„¢ odradzaÃ…â€š!");
        ...
        yml.addDefault(Messages.INTERACT_INVISIBILITY_REMOVED_DAMGE_TAKEN, "&cNie jesteÃ…â€º juÃ…Â¼ niewidzialny, poniewaÃ…Â¼ otrzymaÃ…â€šeÃ…â€º obraÃ…Â¼enia!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_REGULAR_KILL, "{PlayerColor}{PlayerName} &7zostaÃ…â€š popchniÃ„â„¢ty do pustki {KillerColor}{KillerName}&7.");
        yml.addDefault(Messages.PLAYER_DIE_KNOCKED_BY_FINAL_KILL, "{PlayerColor}{PlayerName} &7zostaÃ…â€š popchniÃ„â„¢ty do pustki {KillerColor}{KillerName}&7. &b&lOSTATECZNE ZABÃƒâ€œJSTWO!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_REGULAR, "{PlayerColor}{PlayerName} &7wyszedÃ…â€š podczas walki z {KillerColor}{KillerName}&7.");
        yml.addDefault(Messages.PLAYER_DIE_PVP_LOG_OUT_FINAL, "{PlayerColor}{PlayerName} &7wyszedÃ…â€š podczas walki z {KillerColor}{KillerName}&7. &b&lOSTATECZNE ZABÃƒâ€œJSTWO!");
        ...
        yml.addDefault(Messages.PLAYER_DIE_SHOOT_REGULAR, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zastrzelony {KillerColor}{KillerName}&7!");
        yml.addDefault(Messages.PLAYER_DIE_SHOOT_FINAL_KILL, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zastrzelony {KillerColor}{KillerName}&7! &b&lOSTATECZNE ZABOJSTWO!");
        yml.addDefault(Messages.PLAYER_DIE_DEBUG_REGULAR, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zabity przez pluskwe {KillerColor}{KillerTeamName}");
        yml.addDefault(Messages.PLAYER_DIE_DEBUG_FINAL_KILL, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zabity przez pluskwe {KillerColor}{KillerTeamName} &b&lOSTATECZNE ZABOJSTWO!");
        yml.addDefault(Messages.PLAYER_DIE_IRON_GOLEM_REGULAR, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zabity przez golema {KillerColor}{KillerTeamName}");
        yml.addDefault(Messages.PLAYER_DIE_IRON_GOLEM_FINAL_KILL, "{PlayerColor}{PlayerName} &7zostaÃ…â€š zabity przez golema {KillerColor}{KillerTeamName} &b&lOSTATECZNE ZABOJSTWO!");
        ...
        yml.addDefault(Messages.GAME_END_TOP_PLAYER_CHAT, Arrays.asList("&aÃ¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬Ã¢â€“Â¬",
                ...
                "&6                   &6Ã¢Â­Â &lTOP 1 Zabojca &7- {topTeamColor}{topPlayerDisplayName} &7- &l{topValue}",
        ...
        yml.addDefault(Messages.XP_REWARD_PER_MINUTE, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Czas grania).");
        yml.addDefault(Messages.XP_REWARD_WIN, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Wygrana gra).");
        yml.addDefault(Messages.XP_REWARD_PER_TEAMMATE, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Team Support).");
        yml.addDefault(Messages.XP_REWARD_BED_DESTROY, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Zniszczone lozko).");
        yml.addDefault(Messages.XP_REWARD_REGULAR_KILL, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Regularne zabojstwo).");
        yml.addDefault(Messages.XP_REWARD_FINAL_KILL, "{prefix}&6+{xp} Otrzymano doswiedczenie BukkitBedPlugin (Finalne zabojstwo).");
        ...
        yml.addDefault(Messages.SHOP_SEPARATOR_NAME, "&8Ã¢â€¡Â§ Kategorie");
        yml.addDefault(Messages.SHOP_SEPARATOR_LORE, Collections.singletonList("&8Ã¢â€¡Â© Przedmioty"));
        ...
        yml.addDefault(Messages.SHOP_QUICK_EMPTY_LORE, Arrays.asList("&7To jest szybkie kupowanie!", "&bKucjnij &7aby dodaÃ„â€¡"));
        yml.addDefault(Messages.SHOP_CAN_BUY_COLOR, "&a");
        yml.addDefault(Messages.SHOP_CANT_BUY_COLOR, "&c");
        yml.addDefault(Messages.SHOP_LORE_STATUS_CAN_BUY, "&eKliknij aby kupiÃ„â€¡!");
        yml.addDefault(Messages.SHOP_LORE_STATUS_CANT_AFFORD, "&cNie masz wystarczajÃ„â€¦co {currency}!");
        yml.addDefault(Messages.SHOP_LORE_STATUS_MAXED, "&aMAX!");
        yml.addDefault(Messages.SHOP_LORE_QUICK_ADD, "&bKucnij &7by dodaÃ„â€¡ do szybkiego kupowania");
        yml.addDefault(Messages.SHOP_LORE_QUICK_REMOVE, "&bKucnij &7by usunÃ„â€¦Ã„â€¡ z szybkiego kupowania");
        ...
        yml.addDefault(Messages.REJOIN_DENIED, "{prefix}&cNie moÃ…Â¼esz rejoinowaÃ„â€¡!");
        yml.addDefault(Messages.REJOIN_ALLOWED, "{prefix}&eDoÃ…â€šÃ„â€¦czasz do &a{arena}&e!");
