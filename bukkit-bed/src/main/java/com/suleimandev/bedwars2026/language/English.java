...
public class English extends Language {
    ...
    public English() {
        super(BukkitBedPlugin.plugin, "en");
        ...
        yml.addDefault(Messages.COMMAND_JOIN_SPECTATOR_MSG, "{prefix}Ã‚Â§6You are now spectating Ã‚Â§9{arena}Ã‚Â§6.\n{prefix}Ã‚Â§eYou can leave the arena at any time doing Ã‚Â§c/leaveÃ‚Â§e.");
        ...
        yml.addDefault(Messages.COMMAND_FORCESTART_NOT_IN_GAME, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7You're not playing!");
        yml.addDefault(Messages.COMMAND_FORCESTART_SUCCESS, "Ã‚Â§cÃ¢â€“Âª Ã‚Â§7Countdown shortened!");
        yml.addDefault(Messages.COMMAND_FORCESTART_NO_PERM, "{prefix}&7You can't forcestart the arena.\nÃ‚Â§7Please consider donating for VIP features.");
        ...
        yml.addDefault(Messages.ARENA_START_COUNTDOWN_STOPPED_INSUFF_PLAYERS_CHAT, "{prefix}Ã‚Â§cThere aren't enough players! Countdown stopped!");
        ...
        yml.addDefault(Messages.ARENA_LEAVE_PARTY_DISBANDED, "{prefix}Ã‚Â§cThe party owner has left and the party was disbanded!");
        ...
        yml.addDefault(Messages.INTERACT_CHEST_CANT_OPEN_TEAM_ELIMINATED, "&cYou can'*'t eliminated!");
        ...
        yml.addDefault(Messages.GAME_END_TOP_PLAYER_CHAT, Arrays.asList("",
                ...
                "&6                       &6Ã¢Â­Â &l1st Killer &7- {topTeamColor}{topPlayerDisplayName} &7- &l{topValue}",
        ...
        yml.addDefault(Messages.GENERAL_CONFIGURATION_LOBBY_ITEMS_LORE.replace("%path%", "leave"), Collections.singletonList("&fRight-click to leave BukkitBedPlugin!"));
