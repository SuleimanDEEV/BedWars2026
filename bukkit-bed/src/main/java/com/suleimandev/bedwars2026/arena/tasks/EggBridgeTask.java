...
import com.suleimandev.bedwars2026.api.events.gameplay.EggBridgeBuildEvent;
...
import com.suleimandev.bedwars2026.listeners.EggBridge;
...
public class EggBridgeTask implements Runnable {
    ...
    public EggBridgeTask(Player player, Egg projectile, TeamColor teamColor) {
        ...
        this.player = player;
        task = Bukkit.getScheduler().runTaskTimer(BukkitBedPlugin.plugin, this, 0, 1);
    }
