...
import com.suleimandev.bedwars2026.upgrades.upgradeaction.*;
...
public class UpgradeTier {
    ...
    public UpgradeTier(String parentName, String name, ItemStack displayItem, int cost, Material currency) {
        this.displayItem = BukkitBedPlugin.nms.addCustomData(displayItem, "MCONT_" + parentName);
        this.name = name;
        ...
        for (String action : UpgradesManager.getConfiguration().getYml().getStringList(parentName + "." + name + ".receive")) {
            ...
            switch (type[0].trim().toLowerCase()) {
                case "enchant-item":
                    if (data.length < 3) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid " + type[0] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                    Enchantment e = Enchantment.getByName(data[0].toUpperCase());
                    if (e == null) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid enchantment " + data[0].toUpperCase() + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                    ...
                    if (apply == null) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid apply type " + data[2] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                    int amplifier = 1;
                    try {
                ...
                case "player-effect":
                    ...
                    if (pe == null) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid potion effect " + data[0] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                    ...
                    if (applyType == null) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid apply type " + data[3] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                    int amp = 1, time = 0;
                    try {
                ...
                case "generator-edit":
                    ...
                    if (genType == null) {
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid generator type " + data[0] + " at upgrades2: " + parentName + "." + name);
                    }
                    ...
                    try {
                        ...
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid generator configuration " + data[0] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                ...
                case "dragon":
                    ...
                    try {
                        ...
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid dragon amount at upgrades2: " + parentName + "." + name);
                        continue;
                    }
                ...
                case "command":
                    ...
                    try {
                        ...
                        BukkitBedPlugin.plugin.getLogger().warning("Invalid command type " + data[0] + " at upgrades2: " + parentName + "." + name);
                        continue;
                    }
