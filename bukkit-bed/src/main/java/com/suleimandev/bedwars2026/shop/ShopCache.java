...
public class ShopCache {
    ...
    public void managePermanentsAndDowngradables(Arena arena) {
        BukkitBedPlugin.debug("Restore permanents on death for: " + player);
    ...
    public class CachedItem {
        ...
        public CachedItem(CategoryContent cc) {
            ...
            BukkitBedPlugin.debug("New Cached item " + cc.getIdentifier() + " for player " + player);
        }
        ...
        public void manageDeath(Arena arena) {
            ...
            BukkitBedPlugin.debug("ShopCache Item Restore: " + cc.getIdentifier() + " for " + player);
        ...
        public void upgrade(int slot) {
            ...
            for (ItemStack i : p.getInventory().getContents()) {
                ...
                if (BukkitBedPlugin.nms.getShopUpgradeIdentifier(i).equals(cc.getIdentifier())) {
    ...
    public void upgradeCachedItem(CategoryContent cc, int slot) {
        ...
        if (ci == null) {
            ...
            if (cc.getContentTiers().size() > ci.getTier()) {
                BukkitBedPlugin.debug("Cached item upgrade for " + cc.getIdentifier() + " player " + player);
                ci.upgrade(slot);
            }
        }
    }
