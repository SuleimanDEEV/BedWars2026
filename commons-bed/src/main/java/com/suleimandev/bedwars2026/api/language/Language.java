package com.suleimandev.bedwars2026.api.language;
...
public class Language extends ConfigManager {
    ...
    public String m(String path) {
        ...
        if (null == serverIp) {
            CommonsBedApi api = Bukkit.getServicesManager().getRegistration(CommonsBedApi.class).getProvider();
    ...
    public static void setupCustomStatsMessages() {
        CommonsBedApi api = Bukkit.getServer().getServicesManager().getRegistration(CommonsBedApi.class).getProvider();
