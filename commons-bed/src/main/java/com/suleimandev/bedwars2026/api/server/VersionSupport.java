...
import com.suleimandev.bedwars2026.api.exceptions.InvalidEffectException;
import org.bukkit.*;
...
public abstract class VersionSupport {
    ...
    public static String PLUGIN_TAG_GENERIC_KEY = "BedWars2026";
    ...
    /**
     * Check if an item has a BEDWARS 2026 NBTTag
     */
    public abstract boolean isCustomBedWarsItem(ItemStack i);

    /**
     * Get the NBTTag from a BEDWARS 2026 item
     */
