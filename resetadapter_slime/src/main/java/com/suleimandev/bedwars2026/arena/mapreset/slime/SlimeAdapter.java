package com.suleimandev.bedwars2026.arena.mapreset.slime;
...
public class SlimeAdapter extends RestoreAdapter {
    ...
    private final CommonsBedApi api;

    public SlimeAdapter(Plugin plugin) {
        super(plugin);
        slime = (SlimePlugin) Bukkit.getPluginManager().getPlugin("SlimeWorldManager");
        api = Objects.requireNonNull(Bukkit.getServer().getServicesManager().getRegistration(CommonsBedApi.class)).getProvider();
    }
